...
def read_and_generate_dataset(graph_signal_matrix_filename,
    ...
    #train_week, train_day,
    train_hour, train_target = training_set
    #val_week, val_day, 
    val_hour, val_target = validation_set
    #test_week, test_day, 
    test_hour, test_target = testing_set
    print(train_target)
    print('training data:  recent: {}, target: {}'.format(
      #  train_week.shape, train_day.shape,
        train_hour.shape, train_target.shape))
    print('validation data:  recent: {}, target: {}'.format(
       # val_week.shape, val_day.shape,
          val_hour.shape, val_target.shape))
    print('testing data:  recent: {}, target: {}'.format(
        #test_week.shape, test_day.shape, 
        test_hour.shape, test_target.shape))
    '''
